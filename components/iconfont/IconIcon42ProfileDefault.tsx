...
let IconIcon42ProfileDefault: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconIcon42ProfileDefault.defaultProps = {
  size: 18,
};

IconIcon42ProfileDefault = React.memo ? React.memo(IconIcon42ProfileDefault) : IconIcon42ProfileDefault;

export default IconIcon42ProfileDefault;
